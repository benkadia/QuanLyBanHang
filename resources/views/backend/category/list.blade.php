            ...
            <div id="tableProgress" class="col-lg-12 col-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-6">
                                <h4>Danh mục sản phẩm ({{ $total }} dòng)</h4>
                            </div>
                            <div class="col-6 text-right">
                                <a name="" id="" class="btn btn-primary btn-xs" href="{{route('categories.create')}}" role="button">Thêm mới</a>
                            </div>
                        </div>
                    </div>
                    @if(session('type'))
                    ...
                    <div class="filter-pannel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <a type="text"
                                    class="btn btn-danger btn-xs" href="{{route('categories.index')}}" aria-describedby="helpId" placeholder="">Tất cả</a>
                                  <button type="text"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($list as $item)
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                        <a href="{{route('categories.edit',$item->id)}}" class='btn btn-sm btn-icon btn-pure btn-primary on-default edit-row'>
                                                        Cập nhật
                                                        </a>
                                                        ...
                                                        <form method="post" class="d-none" id="del-{{$item->id}}" action="{{route('categories.destroy',$item->id)}}">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </td>
