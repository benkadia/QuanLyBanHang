                    ...
                    <div class="widget-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <a name="" id="" class="btn btn-primary btn-xs" href="{{route('suppliers.create')}}" role="button">Thêm mới</a>
                            </div>
                        </div>
                    </div>
                    @if(session('type'))
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($list as $item)
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                        <a href="{{route('suppliers.edit',$item->id)}}" class='btn btn-sm btn-icon btn-pure btn-primary on-default edit-row'>
                                                        Cập nhật
                                                        </a>
                                                        ...
                                                        <form method="post" class="d-none" id="del-{{$item->id}}" action="{{route('suppliers.destroy',$item->id)}}">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </td>
