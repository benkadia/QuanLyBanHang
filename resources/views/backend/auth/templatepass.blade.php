                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{asset('upload/template/image-3.jpeg')}}" alt="Image"
                                                                            title="Image"
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{asset('upload/template/image-2.png')}}" alt="Image"
                                                                            title="Image"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{asset('upload/template/image-6.png')}}"
                                                                                            alt="Facebook"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Twitter"
                                                                                        target="_blank">
                                                                                        <img src="{{asset('upload/template/image-5.png')}}"
                                                                                            alt="Twitter"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{asset('upload/template/image-1.png')}}"
                                                                                            alt="Instagram"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="{{asset('upload/template/image-4.png')}}"
                                                                                            alt="LinkedIn"
