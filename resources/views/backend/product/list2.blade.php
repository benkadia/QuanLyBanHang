                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Tên</th>
                                            <th>Số Lượng sp hiện</th>
                                            <th>Số Lượng sp ẩn</th>
                                            <th>Số Lượng sp trash</th>
                                            <th>Số Lượng sp</th>
                                            <th>Status</th>
                                            <th>Thao Tác</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($list as $item)
                                                <tr>
                                                    <td>{{$item->name}}</td>
                                                    <td>{{$item->products_show}}</td>
                                                    <td>{{$item->products_hide}}</td>
                                                    <td>{{$item->products_trash}}</td>
                                                    ...
                                                    <td class="actions">
                                                        <a href="{{route('products.edit',$item->id)}}" class='btn btn-sm btn-icon btn-pure btn-default on-default edit-row'>
                                                        Cập nhật
                                                        </a>
                                                        <a onclick="if(confirm('Are you sure?')){document.getElementById('del-{{$item->id}}').submit()}" class='btn btn-sm btn-icon btn-pure btn-default on-default remove-row'>
                                                        Xóa
                                                        </a>
